...
(function() {
  var MangaFox, MangaHere, MangaReader, MangaStream, Prerenderer, absoluteUrl, prerenderer, _ref, _ref1, _ref2, _ref3,
  ...
  MangaFox = (function(_super) {
    __extends(MangaFox, _super);

    function MangaFox() {
      _ref2 = MangaFox.__super__.constructor.apply(this, arguments);
      return _ref2;
    }

    MangaFox.prototype.nextPageSelector = "a.next_page:first";

    return MangaFox;

  })(Prerenderer);

  MangaStream = (function(_super) {
    __extends(MangaStream, _super);

    function MangaStream() {
      _ref3 = MangaStream.__super__.constructor.apply(this, arguments);
      return _ref3;
    }

    MangaStream.prototype.nextPageSelector = "#controls a.active + a";
